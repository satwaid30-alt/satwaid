...
export default function ShippingInfo({ order }) {
    ...
    return (
        <>
            ...
            <div className="bg-zinc-900 border border-zinc-800 rounded-[3rem] p-10 shadow-2xl space-y-10 animate-in slide-in-from-top-4 duration-500 relative overflow-hidden">
                {/* Decorative Background */}
                <div className="absolute top-0 right-0 w-64 h-64 bg-blue-500/5 blur-[100px] -z-10 rounded-full"></div>

                <div className="flex flex-col md:flex-row items-center justify-between gap-6 border-b border-zinc-800 pb-5">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                    ...
                    <div className="space-y-6">
                        <div className="bg-zinc-950/50 p-8 rounded-[2.5rem] border border-zinc-800 space-y-6 shadow-inner">
                            <div>
                    ...
                    <div className="space-y-4">
                        ...
                        <div
                            ...
                            className="aspect-[4/3] rounded-[2.5rem] bg-zinc-950 border border-zinc-800 overflow-hidden relative group cursor-pointer shadow-inner"
                        >
                            {order.shipping_proof ? (
                                <>
                                    <img
                                        src={`${process.env.NEXT_PUBLIC_API_URL}${order.shipping_proof}`}
