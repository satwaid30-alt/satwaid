    ...
    return (
        <div className="max-w-7xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                ...
                <Link
                    href="/user/pesanan"
                    className="flex items-center gap-2 px-6 py-3 bg-zinc-900 border border-zinc-800 text-zinc-400 hover:text-white rounded-2xl transition-all text-xs font-black uppercase tracking-widest group"
                >
                                        ...
                                        {filteredOrders.map((order, index) => (
                                            <tr key={order.id} className="hover:bg-zinc-800/20 transition-colors group">
                                                <td className="px-4 py-6 text-center">
                                                    <span className="text-[11px] font-black text-zinc-600 font-mono">{index + 1}</span>
                                                </td>
                                                ...
                                                <td className="px-6 py-6">
                                                    <div className="flex items-center gap-4">
                                                        ...
                                                        <div className="min-w-0">
                                                            ...
                                                            <p className="text-[10px] font-bold text-zinc-500 uppercase tracking-tighter">{order.quantity} Item • {order.product?.type === 'sell' ? 'Beli' : 'Lelang'}</p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td className="px-6 py-6">
                                                ...
                                                <td className="px-6 py-6">
                                                    <div className="flex justify-center">
                                                        <span className="px-3 py-1 rounded-full bg-emerald-500/10 text-emerald-500 border border-emerald-500/20 text-[9px] font-black uppercase tracking-widest whitespace-nowrap">
                                                            Selesai
                                                        </span>
                                                    </div>
                                                </td>
                            ...
                            {filteredOrders.map((order) => (
                                ...
                                >
                                    ...
                                    <div className="px-5 py-4 bg-zinc-900/40 border-t border-zinc-800 flex items-center gap-3">
                                        <Link
                                            href={`/user/pesanan/detail-pesanan/${order.id}`}
                                            className="flex-1 flex items-center justify-center gap-2 py-2.5 bg-zinc-800 hover:bg-zinc-700 text-white rounded-xl border border-zinc-700 text-[10px] font-black uppercase tracking-widest transition-all"
                                        >
                                            <Eye size={14} /> Detail
                                        </Link>
                                    </div>
