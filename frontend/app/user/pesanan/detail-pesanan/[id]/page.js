        ...
        <div className="max-w-7xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700 pb-20">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                ...
                <div className="lg:col-span-8 space-y-8">
                    ...
                    <div className={`p-8 rounded-[2.5rem] border flex items-center justify-between shadow-2xl ${source === 'cart' ? 'bg-zinc-800 text-zinc-400 border-zinc-700' : getStatusStyle(order.status)}`}>
                        <div className="space-y-1">
                            <p className="text-[10px] font-black uppercase tracking-widest opacity-70">Status Terkini</p>
                            <h2 className="text-2xl font-black">{source === 'cart' ? 'Dalam Keranjang' : getStatusLabel(order.status)}</h2>
                        </div>
                        ...
                        <div className="p-8 lg:p-10 space-y-10">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="bg-zinc-950 border border-zinc-800 rounded-3xl overflow-hidden relative aspect-square group shadow-inner">
                                ...
                                <div className="space-y-8">
                                    <div className="space-y-4">
                                        ...
                                        <div>
                                            ...
                                            <div className="flex flex-wrap gap-2">
                                                ...
                                                <span className={`px-3 py-1 text-[10px] rounded-lg border font-bold uppercase tracking-wider ${order.product?.sex === 'Male' ? 'bg-blue-500/10 text-blue-400 border-blue-500/20' : order.product?.sex === 'Female' ? 'bg-pink-500/10 text-pink-400 border-pink-500/20' : 'bg-zinc-500/10 text-zinc-400 border-zinc-500/20'}`}>
                                                ...
                                                <span className="px-3 py-1 bg-emerald-500/10 text-emerald-400 rounded-lg border border-emerald-500/20 text-[10px] font-bold uppercase tracking-wider">
                                                    {order.product?.type === 'sell' ? 'Direct Sell' : 'Auction'}
                                                </span>
                                    ...
                                    <div className="flex items-center gap-3 p-4 bg-blue-500/5 border border-dashed border-blue-500/20 rounded-2xl">
                                        <div className="w-10 h-10 bg-blue-500 rounded-xl flex items-center justify-center text-zinc-950 font-black border border-blue-500/20 shadow-lg shadow-blue-500/10 shrink-0">
                                            <Truck size={20} />
                                        </div>
                                        <div>
                                    ...
                                    <div className="p-6 bg-zinc-950/30 rounded-3xl border border-zinc-800 space-y-4">
                                        <div className="flex items-center gap-4">
                                            <div className="w-12 h-12 bg-zinc-800 rounded-xl flex items-center justify-center text-emerald-500 shrink-0 border border-zinc-700 overflow-hidden">
                                                {order.shop?.logo_url ? <img src={order.shop.logo_url} className="w-full h-full object-cover" /> : <Store size={24} />}
                                            </div>
                ...
                <div className="lg:col-span-4 space-y-8">
                        ...
                        <div className=" space-y-3">
                            {source === 'cart' && (
                                <button
                                    ...
                                    className="w-full py-4 bg-emerald-500 hover:bg-emerald-400 text-zinc-950 rounded-2xl text-sm font-black transition-all shadow-lg shadow-emerald-500/20 active:scale-[0.98] flex items-center justify-center gap-2 disabled:opacity-50"
                                >
                                    {isProcessingCart ? (
                            ...
                            {order.status === 'waiting_payment' && (
                                <button className="w-full py-4 bg-emerald-500 hover:bg-emerald-400 text-zinc-950 rounded-2xl text-sm font-black transition-all shadow-lg shadow-emerald-500/20 active:scale-[0.98]">
                                    Bayar Sekarang
                                </button>
                            )}
                        </div>
                    ...
                    {/* Delivery Info */}
                    {source !== 'cart' && (
                        <div className="bg-zinc-900 border border-zinc-800 rounded-[2.5rem] p-8 lg:p-10 shadow-2xl space-y-6">
                            <h3 className="text-xs font-black text-zinc-500 uppercase tracking-widest flex items-center gap-2">
                            ...
                            <form onSubmit={handleShippingSubmit} className="space-y-4">
                                ...
                                <div className="flex gap-4 pt-4">
                                    ...
                                    <button
                                        ...
                                        className="flex-1 py-4 bg-emerald-500 hover:bg-emerald-400 text-zinc-950 font-black rounded-2xl transition-all shadow-lg shadow-emerald-500/20 disabled:opacity-50"
                                    >
