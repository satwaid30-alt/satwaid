...
export default function PengaduanUserPage() {
  return (
    <div>
      ...
      <div className="bg-zinc-900 border border-zinc-800 rounded-[10px] p-6 md:p-8 flex flex-col md:flex-row items-center justify-between gap-6 mb-8 relative overflow-hidden shadow-2xl">
        <div className="absolute top-0 right-0 p-8 opacity-[0.03] pointer-events-none text-emerald-500">
          <MessageSquare size={200} />
        </div>
        <div className="flex items-center gap-5 z-10">
          <div className="w-16 h-16 bg-emerald-500/10 text-emerald-400 rounded-[10px] flex items-center justify-center border border-emerald-500/20 shrink-0 shadow-lg shadow-emerald-500/5">
