    ...
    <div className="min-h-screen bg-zinc-950 text-zinc-300 py-6 sm:py-12 px-3 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        <div className="mb-6 sm:mb-10 flex flex-col md:flex-row md:items-center justify-between gap-4 sm:gap-6">
          <div>
            <Link href="/user/toko" className="inline-flex items-center gap-2 text-zinc-500 hover:text-emerald-500 transition-all mb-3 sm:mb-4 group font-bold text-sm">
        ...
        <div className="sm:bg-zinc-900/40 sm:border sm:border-zinc-800/50 sm:rounded-[2.5rem] sm:p-1 sm:shadow-2xl sm:backdrop-blur-3xl overflow-hidden">
          <form onSubmit={handleUpdateShop} className="sm:p-8 md:p-10 space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {bankAccounts.length > 0 ? (
                  ...
                  <div className="col-span-full py-6 px-4 bg-zinc-950/20 border border-dashed border-zinc-800 rounded-2xl text-center">
                    ...
                    <Link href="/user/pengaturan" className="text-[10px] text-emerald-500 hover:underline uppercase font-black mt-2 inline-block tracking-widest">
            ...
            <div className="pt-6 sm:pt-10 border-t border-zinc-800/50 flex flex-col sm:flex-row gap-3 sm:gap-5">
              <Link href="/user/toko" className="flex-1 bg-zinc-950 hover:bg-zinc-900 text-zinc-500 hover:text-white font-black py-4 sm:py-5 rounded-xl sm:rounded-2xl text-center transition-all border border-zinc-800 flex items-center justify-center gap-2 group text-sm">
        ...
        <ActionModal isOpen={modalConfig.isOpen} onClose={() => setModalConfig({ ...modalConfig, isOpen: false })} onConfirm={modalConfig.onConfirm} type={modalConfig.type} title={modalConfig.title} message={modalConfig.message} />
      </div>
      <style jsx global>{`
