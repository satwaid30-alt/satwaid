                            ...
                            {parsedImages?.length > 1 && (
                                <div className="absolute inset-x-4 top-1/2 -translate-y-1/2 flex justify-between opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none">
                                    <button
                                        ...
                                        className="p-3 lg:p-4 bg-zinc-900/80 backdrop-blur-md text-white rounded-xl lg:rounded-2xl hover:bg-emerald-500 hover:text-zinc-950 transition-all pointer-events-auto"
                                    >
                            ...
                            <div className="p-4 lg:p-6 bg-zinc-950/30 border-t border-zinc-800 flex gap-3 lg:gap-4 overflow-x-auto custom-scrollbar">
                                {parsedImages?.map((img, idx) => (
                                    <button
                                        ...
                                        className={`w-16 h-16 lg:w-20 lg:h-20 rounded-xl lg:rounded-2xl overflow-hidden border-2 shrink-0 transition-all duration-300 ${activeImageIndex === idx ? 'border-emerald-500 scale-105' : 'border-zinc-800 opacity-40 hover:opacity-100'}`}
                                    >
                        ...
                        <div className="relative space-y-8">
                            <div className="space-y-4">
                                <div className="flex flex-wrap items-center gap-3">
                                    <span className={`px-4 py-1.5 rounded-full text-[10px] font-black uppercase tracking-[0.2em] border ${listing.status?.toLowerCase() === 'sold' || listing.type === 'sell'
                            ...
                            <div className={`rounded-3xl p-8 border group/price relative overflow-hidden shadow-2xl ${listing.type === 'auction' ? 'bg-amber-500/5 border-amber-500/20' : 'bg-zinc-950 border-zinc-800'}`}>
                                ...
                                <div className="relative">
                                    <p className="text-[10px] font-black text-zinc-500 uppercase tracking-[0.3em] mb-3">
                                        {listing.type === 'sell' ? 'Harga' : 'Open Bid (OB)'}
                                    </p>
                                                    ...
                                                    <div className="flex items-center gap-3 bg-zinc-900/50 p-4 rounded-2xl border border-zinc-800">
                                                        <div className="w-10 h-10 rounded-full bg-zinc-800 border border-zinc-700 overflow-hidden flex-shrink-0 flex items-center justify-center">
                                                            {bids[0].bidder?.avatar_url ? (
                                                                <img src={getAvatarUrl(bids[0].bidder.avatar_url)} alt="avatar" className="w-full h-full object-cover" />
                                                            ) : (
