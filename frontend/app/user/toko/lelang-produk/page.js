  ...
  if (!hasShop) {
    return (
      <div className="max-w-4xl mx-auto py-20 text-center space-y-6">
        ...
        <Link href="/user/toko" className="inline-flex items-center gap-2 px-8 py-4 bg-amber-500 hover:bg-amber-400 text-zinc-950 font-black rounded-2xl transition-all shadow-lg shadow-amber-500/20">
          Buka Toko Sekarang
    ...
    <div className="max-w-5xl mx-auto py-10 space-y-10 animate-in fade-in duration-500">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        ...
        <div className="flex flex-wrap items-center gap-3">
          <Link href="/user/toko/daftar-produk" className="px-5 py-2.5 bg-zinc-900 hover:bg-zinc-800 text-white text-sm font-bold rounded-xl border border-zinc-800 transition-all flex items-center gap-2">
            Lihat Iklan Saya
          </Link>
        </div>
      </div>
            ...
            <form onSubmit={handleAddAuction} className="px-0 py-6 sm:p-8 space-y-8">
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <input type="number" required min="1" className="w-full bg-zinc-950 border border-zinc-800 text-white rounded-2xl px-5 py-4 focus:outline-none focus:border-amber-500 transition-all font-bold shadow-inner" value={reptileData.stock} onChange={(e) => setReptileData({ ...reptileData, stock: e.target.value })} />
                  </div>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
              ...
              <div className="pt-8 border-t border-zinc-800">
                <label className="flex items-start gap-4 cursor-pointer group mb-8 px-2">
                  ...
                  <span className="text-xs font-bold text-zinc-500 group-hover:text-zinc-300 transition-colors leading-relaxed">Saya menyatakan bahwa data lelang dan ketentuan di atas adalah benar. Saya bertanggung jawab penuh atas proses lelang ini.</span>
                </label>
            ...
            <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
              ...
              <div className="bg-zinc-900 border border-zinc-800 rounded-[2.5rem] w-full max-w-md p-12 text-center relative z-10 shadow-[0_0_100px_rgba(245,158,11,0.1)] animate-in zoom-in-95 duration-300">
                ...
                <div className="grid grid-cols-1 gap-4">
                  {createdListingId && (
                    <Link href={`/toko/detail-lelang/${createdListingId}`} className="w-full bg-amber-500 hover:bg-amber-400 text-zinc-950 font-black py-4 rounded-2xl transition-all shadow-xl flex items-center justify-center gap-2 active:scale-95">
                      <Gavel size={20} />
                      Buka Detail Lelang
                    </Link>
                  )}
          ...
          {showErrorModal && (
            <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
              ...
              <div className="bg-zinc-900 border border-zinc-800 rounded-[2.5rem] w-full max-w-md p-12 text-center relative z-10 shadow-2xl animate-in zoom-in-95 duration-300">
                ...
                <button onClick={() => setShowErrorModal(false)} className="w-full bg-red-500 hover:bg-red-400 text-zinc-950 font-black py-4 rounded-2xl transition-all shadow-xl shadow-red-500/20">
                  Saya Mengerti
                </button>
              </div>
            </div>
