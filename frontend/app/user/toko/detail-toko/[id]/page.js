      ...
      <div className="max-w-7xl mx-auto space-y-6 sm:space-y-10 animate-in fade-in duration-500">
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-2xl sm:rounded-3xl p-4 sm:p-8 relative overflow-hidden">
          ...
          <div className="flex flex-col xs:flex-row items-center gap-4 sm:gap-8 relative z-10">
            ...
            <div className="flex gap-2 sm:gap-3 w-full sm:w-auto shrink-0">
              <Link href="/user/toko/edit-toko" className="flex-1 sm:flex-none px-3 sm:px-5 py-2 sm:py-2.5 bg-zinc-800 hover:bg-zinc-700 text-white text-xs sm:text-sm font-bold rounded-lg sm:rounded-xl transition-all flex items-center justify-center gap-2">
                Edit Toko
              </Link>
              <Link href="/user/toko/dashboard" className="flex-1 sm:flex-none px-3 sm:px-5 py-2 sm:py-2.5 bg-emerald-500 hover:bg-emerald-400 text-zinc-950 text-xs sm:text-sm font-black rounded-lg sm:rounded-xl transition-all flex items-center justify-center gap-2">
                Dashboard
              </Link>
            </div>
          </div>
        ...
        {shopData.status?.toLowerCase() === "suspended" && (
          <div className="bg-red-500/10 border border-red-500/20 rounded-3xl p-8 flex flex-col md:flex-row items-center gap-6 animate-in slide-in-from-top-4 duration-500">
            ...
            <button onClick={() => window.open("https://wa.me/628123456789", "_blank")} className="px-6 py-3 bg-white text-zinc-950 font-black rounded-xl hover:bg-zinc-200 transition-all active:scale-95 text-sm">
              Hubungi Admin
            </button>
          </div>
        )}
        ...
        {shopData.status?.toLowerCase() === "rejected" && (
          <div className="bg-orange-500/10 border border-orange-500/20 rounded-3xl p-8 flex flex-col md:flex-row items-center gap-6 animate-in slide-in-from-top-4 duration-500">
            ...
            <div className="flex flex-col gap-3">
              <Link href="/user/toko/edit-toko" className="px-6 py-3 bg-white text-zinc-950 font-black rounded-xl hover:bg-zinc-200 transition-all active:scale-95 text-sm whitespace-nowrap text-center">
                Perbaiki Profil
              </Link>
              <button onClick={handleResubmit} disabled={isSubmitting} className="px-6 py-3 bg-orange-500 text-white font-black rounded-xl hover:bg-orange-400 transition-all active:scale-95 text-sm whitespace-nowrap disabled:opacity-50 disabled:cursor-not-allowed">
