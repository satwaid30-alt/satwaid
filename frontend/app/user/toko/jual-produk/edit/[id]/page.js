...
import { ArrowLeft, CheckCircle2, X, Image as ImageIcon, Gavel, Tag, Truck, AlertCircle, ScrollText, Save, ChevronRight, Loader2 } from "lucide-react";
    ...
    <div className="min-h-screen bg-zinc-950">
      <div className="max-w-5xl mx-auto py-6 sm:py-10 px-0 sm:px-6 lg:px-8 space-y-6 sm:space-y-10">
        ...
        <div className="px-4 sm:px-0 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div>
            <Link href="/user/toko/daftar-produk" className="inline-flex items-center gap-2 text-zinc-500 hover:text-white transition-all mb-3 group font-black text-[10px] uppercase tracking-widest">
              <ArrowLeft size={14} className="group-hover:-translate-x-1 transition-transform" />
              Kembali ke Daftar
            </Link>
            <h1 className="text-xl sm:text-3xl font-black text-white tracking-tight flex items-center gap-3">Edit Produk</h1>
            ...
            {listingType === "sell" ? (
              ...
              <div className="sm:p-6 sm:bg-zinc-950/50 sm:border sm:border-zinc-800 sm:rounded-3xl space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  <div className="space-y-2">
                    <label className="text-xs font-black text-zinc-300 uppercase tracking-widest ml-1">
                      Kelipatan / Multiple (Rp) <span className="text-red-500">*</span>
                    </label>
                    <input
                      type="text"
                      inputMode="numeric"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-start">
                  <div className="px-1 py-1">
                    <p className="text-[11px] font-bold text-amber-500/80 italic leading-tight">* Belum termasuk ongkir &amp; packing.</p>
                  </div>
                  <div className="space-y-3">
                    <p className="text-[10px] font-black text-zinc-500 uppercase tracking-widest ml-1">Opsi Tambahan</p>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
