          ...
          <div className="bg-zinc-900 border border-zinc-800 rounded-3xl md:rounded-[2.5rem] p-4 md:p-8 space-y-6 md:space-y-8">
            ...
            <div className="space-y-3 pt-4">
              ...
              <button
                ...
                className="w-full py-4 bg-[#22C55E] hover:bg-[#1DA851] text-[#FFFFFF] rounded-2xl transition-all font-bold text-xs flex items-center justify-center gap-2.5 active:scale-95 border border-[#25D366]/20"
              >
