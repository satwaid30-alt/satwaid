...
export default function UserTokoPage() {
    ...
    const handleCreateShop = async (e) => {
        ...
        if (!shopData.name || !shopData.nik || !shopData.whatsapp || !shopData.province || !shopData.city || !shopData.address || !shopData.logo_url || !shopData.description || shopData.description === "<p><br></p>" || !shopData.shipping_policy || shopData.shipping_policy === "<p><br></p>" || !shopData.warranty_policy || shopData.warranty_policy === "<p><br></p>") {
            setModalConfig({
                isOpen: true,
                type: "warning",
            ...
            <div className="min-h-[80vh] flex flex-col items-center justify-center py-10 px-4 sm:px-6 lg:px-8 bg-zinc-950">
                ...
                <div className="max-w-4xl w-full text-center space-y-8 animate-in fade-in slide-in-from-bottom-8 duration-700">
                    ...
                    <div className="space-y-4">
                        ...
                        <p className="max-w-2xl mx-auto text-zinc-500 text-base sm:text-xl font-medium leading-relaxed">
                            Bangun toko profesional Anda di SatwaiD dan jual satwa, perlengkapan, serta kebutuhan hobi dengan aman dan terpercaya.
                        </p>
                    </div>
                    ...
                    <div className="pt-12 flex flex-col sm:flex-row items-center justify-center gap-4">
                        ...
                        <Link
                            href="/"
                            className="w-full sm:w-auto px-10 py-5 bg-zinc-900 hover:bg-zinc-800 text-white font-black text-lg rounded-2xl transition-all border border-zinc-800 flex items-center justify-center"
                        >
                            Kembali ke Beranda
                        </Link>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="flex items-center gap-3 sm:gap-5">
                            ...
                            <div>
                                ...
                                <p className="text-zinc-500 text-xs mt-0.5 sm:mt-1">Mulai perjalanan bisnis reptil Anda.</p>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                                <div className="space-y-3 group">
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            type="text"
                                            className="w-full bg-zinc-950/50 border border-zinc-800 text-white rounded-2xl pl-12 pr-4 py-3.5 sm:py-4 focus:outline-none focus:border-emerald-500/50 focus:ring-4 focus:ring-emerald-500/5 transition-all font-bold placeholder:text-zinc-700 text-sm sm:text-base"
                                ...
                                <div className="space-y-3 group">
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            className="w-full bg-zinc-950/50 border border-zinc-800 text-white rounded-2xl pl-12 pr-4 py-3.5 sm:py-4 focus:outline-none focus:border-emerald-500/50 focus:ring-4 focus:ring-emerald-500/5 transition-all font-bold placeholder:text-zinc-700 tracking-widest text-sm sm:text-base"
                                            value={shopData.nik || ""}
                        ...
                        <section className="space-y-6">
                            ...
                            <div className="space-y-3 group">
                                ...
                                <div className="relative">
                                    ...
                                    <textarea
                                        rows="2"
                                        className="w-full bg-zinc-950/50 border border-zinc-800 text-white rounded-2xl pl-12 pr-4 py-3.5 sm:py-4 focus:outline-none focus:border-emerald-500/50 focus:ring-4 focus:ring-emerald-500/5 transition-all font-bold placeholder:text-zinc-700 resize-none text-sm sm:text-base"
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                {userBankAccounts.length > 0 ? (
                                    ...
                                    <div className="col-span-full py-6 px-4 bg-zinc-950/20 border border-dashed border-zinc-800 rounded-2xl text-center">
                                        ...
                                        <Link href="/user/profil" className="text-[10px] text-emerald-500 hover:underline uppercase font-black mt-2 inline-block tracking-widest">Lengkapi di Profil Dahulu</Link>
                                    </div>
                                )}
                            </div>
                        </section>
                                                ...
                                                onChange={(e) => {
                                                    ...
                                                    if (file) {
                                                        if (file.size > 500 * 1024) {
                                                            setModalConfig({ isOpen: true, type: "warning", title: "File Terlalu Besar", message: "Ukuran foto tidak boleh lebih dari 500KB." });
                    ...
                    <div className="bg-zinc-900 border border-zinc-800 rounded-[2.5rem] w-full max-w-2xl max-h-[90vh] overflow-hidden flex flex-col relative z-10 animate-in zoom-in-95 duration-300">
                                ...
                                <div className="space-y-6">
                                    <section>
                                        ...
                                        <p className="text-zinc-400 text-sm leading-relaxed ml-8">
                                            Dengan melanjutkan proses pembuatan toko, Anda menyatakan telah membaca, memahami, dan menyetujui seluruh ketentuan yang berlaku.
                                        </p>
                                    </section>
                                    ...
                                    <section>
                                        ...
                                        <p className="text-zinc-400 text-sm leading-relaxed ml-8">
                                            Anda wajib mengisi seluruh informasi toko dan data diri dengan benar, lengkap, dan dapat dipertanggungjawabkan.
                                        </p>
                                    </section>
                                    ...
                                    <section>
                                        ...
                                        <p className="text-zinc-400 text-sm leading-relaxed ml-8">
                                            Anda wajib mematuhi seluruh peraturan jual beli yang berlaku, termasuk larangan menjual hewan ilegal atau dilindungi.
                                        </p>
                                    </section>
                                    ...
                                    <section>
                                        ...
                                        <p className="text-zinc-400 text-sm leading-relaxed ml-8">
                                            Seluruh transaksi wajib dilakukan melalui Admin Platform sebagai pihak ketiga (rekening bersama). Segala bentuk transaksi di luar platform bukan menjadi tanggung jawab Admin.
                                        </p>
                                    </section>
                                    ...
                                    <section>
                                        ...
                                        <p className="text-zinc-400 text-sm leading-relaxed ml-8">
                                            Anda bertanggung jawab penuh atas produk yang dijual, termasuk keaslian, kondisi, dan pengiriman.
                                        </p>
                                    </section>
                                    ...
                                    <section>
                                        ...
                                        <p className="text-zinc-400 text-sm leading-relaxed ml-8">
                                            Pelanggaran terhadap ketentuan ini dapat mengakibatkan pembatasan hingga penghapusan akun/toko secara permanen.
                                        </p>
                                    </section>
                                </div>
                            </div>
                        ...
                        <div className="p-8 border-t border-zinc-800 bg-zinc-900/50 shrink-0">
                            <label className="flex items-start gap-4 mb-6 cursor-pointer group">
                                ...
                                <span className="text-sm text-zinc-400 font-medium leading-snug group-hover:text-zinc-200 transition-colors">
                                    Dengan mencentang persetujuan, Anda setuju untuk terikat secara hukum dengan ketentuan yang berlaku di Reptile Haven.
                                </span>
                            </label>
