        ...
        <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="bg-zinc-900 border border-zinc-800 rounded-3xl p-6 md:p-8 shadow-xl">
                ...
                <form onSubmit={handleSave} className="space-y-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="space-y-1.5">
                                ...
                                <input
                                    ...
                                    className="w-full bg-zinc-950 border border-zinc-800 text-white rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all"
                                />
                            </div>
                            <div className="space-y-1.5">
                                ...
                                <input
                                    ...
                                    value={user.username}
                                    disabled
                                    className="w-full bg-zinc-950/50 border border-zinc-800 text-zinc-500 rounded-xl px-4 py-3 cursor-not-allowed"
                                />
                            ...
                            <div className="space-y-1.5">
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        value={user.phone}
                                        onChange={handleChange}
                                        className="w-full bg-zinc-950 border border-zinc-800 text-white rounded-xl pl-12 pr-4 py-3 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all"
                                    />
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="pt-6 border-t border-zinc-800">
                        <div className="flex justify-between items-center mb-4">
                            ...
                            <button
                                ...
                                className="flex items-center gap-1.5 px-3 py-1.5 bg-emerald-500/10 hover:bg-emerald-500 text-emerald-500 hover:text-zinc-950 text-sm font-bold rounded-lg transition-colors"
                            >
                                <Plus size={16} />
                                Tambah Rekening
                            </button>
                    ...
                    </div>                    <div className="pt-6 mt-6 border-t border-zinc-800 flex justify-end gap-3">
                        <Link
