    ...
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="mb-8 flex items-start justify-between">
        <div>
          ...
          <p className="text-zinc-400">{isNewUser ? "Selamat datang! Lengkapi profil Anda untuk memulai." : "Kelola informasi data diri dan kontak."}</p>
        </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-1.5">
                  ...
                  <input type="text" name="name" value={user.name} onChange={handleChange} disabled={!isEditMode} placeholder={isEditMode ? "Nama lengkap Anda" : ""} className={inputClass()} />
                </div>
                <div className="space-y-1.5">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    ...
                    <input type="tel" name="phone" value={user.phone} onChange={handleChange} disabled={!isEditMode} placeholder="08xxxxxxxxxx" className={inputClass("pl-12")} />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="pt-6 border-t border-zinc-800">
              ...
              <div className="space-y-6">
                <div className="space-y-1.5">
                  ...
                  <textarea name="address" value={user.address} onChange={handleChange} disabled={!isEditMode} rows={3} placeholder={isEditMode ? "Nama Jalan, Gedung, No. Rumah, RT/RW, Patokan" : ""} className={inputClass("resize-none")} />
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="relative">
                      ...
                      {isEditMode && showProvinceDropdown && (
                        <div className="absolute z-50 w-full mt-2 bg-zinc-900 border border-zinc-700 rounded-xl max-h-60 overflow-y-auto custom-scrollbar">
                          ...
                          {provinces.filter((p) => p.name.toLowerCase().includes((provinceSearch || "").toLowerCase())).length === 0 && <div className="px-4 py-3 text-zinc-500 text-sm italic font-bold">Tidak ditemukan</div>}
                        </div>
                      )}
                      {isEditMode && showProvinceDropdown && <div className="fixed inset-0 z-40" onClick={() => setShowProvinceDropdown(false)}></div>}
                    </div>
                  </div>
                  <div className="space-y-1.5 relative">
                    ...
                    <div className="relative">
                      ...
                      {isEditMode && showCityDropdown && cities.length > 0 && (
                        <div className="absolute z-50 w-full mt-2 bg-zinc-900 border border-zinc-700 rounded-xl max-h-60 overflow-y-auto custom-scrollbar">
                          ...
                          {cities.filter((c) => c.name.toLowerCase().includes((citySearch || "").toLowerCase())).length === 0 && <div className="px-4 py-3 text-zinc-500 text-sm italic font-bold">Tidak ditemukan</div>}
                        </div>
                      )}
                      {isEditMode && showCityDropdown && <div className="fixed inset-0 z-40" onClick={() => setShowCityDropdown(false)}></div>}
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="bg-zinc-900 border border-zinc-800 w-full max-w-lg rounded-[3rem] relative z-10 overflow-hidden animate-in zoom-in-95 slide-in-from-bottom-8 duration-500">
            <div className="p-10 lg:p-12 space-y-8 text-center relative">
              ...
              <div className="space-y-4">
                ...
                <p className="text-zinc-400 text-sm font-medium leading-relaxed">{isNewUser ? "Selamat datang! Silakan lengkapi data profil Anda untuk mempermudah proses transaksi di Satwa iD." : "Kelola data diri, alamat pengiriman, dan informasi rekening bank Anda di sini."}</p>
              </div>
              ...
              <p className="text-[10px] text-zinc-500 font-bold uppercase tracking-widest opacity-50">Satwa iD - Professional Marketplace</p>
            </div>
          </div>
        </div>
      )}
