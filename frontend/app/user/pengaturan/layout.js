...
export default function PengaturanLayout({ children }) {
    ...
    return (
      <div className="min-h-screen bg-zinc-950 flex items-center justify-center text-white">
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-zinc-400 font-medium animate-pulse">Memuat Data Akun...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-zinc-950 text-white flex flex-col md:flex-row">
      ...
      <div className="flex-1 flex flex-col min-h-screen overflow-hidden">
        ...
        <main className="flex-1 p-6 md:p-12 overflow-y-auto custom-scrollbar flex flex-col">
          <div className="max-w-4xl mx-auto flex-1 w-full">{children}</div>
