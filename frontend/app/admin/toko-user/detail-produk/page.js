          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="border-b border-zinc-800 bg-zinc-950/50">
                <th className="p-6 text-[10px] font-black text-zinc-300 uppercase tracking-[0.2em]">
                  No.
                </th>
                <th className="p-6 text-[10px] font-black text-zinc-300 uppercase tracking-[0.2em]">
                  Produk
                ...
                <th className="p-6 text-[10px] font-black text-zinc-300 uppercase tracking-[0.2em] text-center">
                  Aksi
                </th>
              </tr>
            </thead>
                ...
                paginatedListings.map((item, index) => {
                  ...
                  return (
                    ...
                    >
                        ...
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                            ...
                            <div className="flex items-center gap-2 mt-0.5">
                              ...
                              {item.product_id && (
                                <>
                                  ...
                                  <p className="text-[10px] font-mono font-black text-zinc-400">
                                    {item.product_id}
                                  </p>
                                </>
                              )}
                            ...
                            <div className="flex items-center gap-2 mt-1">
                              <span
                                className={`px-2 py-0.5 rounded text-[8px] font-black uppercase tracking-tighter border ${item.type === "sell" ? "bg-blue-500/10 text-blue-400 border-blue-500/20" : "bg-amber-500/10 text-amber-400 border-amber-500/20"}`}
                              >
                      ...
                      <td className="p-6">
                        <div className="flex items-center gap-2">
                          <div className="w-6 h-6 rounded-lg bg-zinc-800 border border-zinc-700 flex items-center justify-center overflow-hidden shrink-0">
                            {item.shop?.logo_url ? (
                              <img
                                src={getLogoUrl(item.shop.logo_url)}
                                className="w-full h-full object-cover"
                              />
                            ) : (
                      ...
                      <td className="p-6">
                        <p className="text-sm font-black text-white">
                          ...
                          {new Number(
                            item.type === "sell"
                              ? item.price
                              : item.current_bid || item.start_bid,
                      ...
                      <td className="p-6">
                        <span
                          className={`px-4 py-1.5 rounded-full text-[10px] font-black uppercase tracking-widest border shadow-sm w-fit ${getStatusStyles(item.status)}`}
                        >
                          {item.status || "Active"}
                        </span>
                      </td>
                ...
                <div className="p-5 space-y-4">
                  <div className="flex gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        {item.product_id && (
                          <p className="text-[9px] font-mono font-black text-zinc-500 bg-zinc-950 px-1.5 py-0.5 rounded border border-zinc-800">
                            {item.product_id}
                          </p>
                        )}
                      </div>
                  ...
                  <div className="grid grid-cols-2 gap-3 pt-1">
                    <div className="p-3 bg-zinc-950/40 border border-zinc-800/50 rounded-xl">
                      ...
                      <p className="text-[9px] text-emerald-500 font-black mt-0.5">
                        Stok: {item.stock || 0}
                      </p>
                    </div>
                    <div className="p-3 bg-zinc-950/40 border border-zinc-800/50 rounded-xl">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between border-t border-zinc-800 px-4 py-8 gap-6 sm:px-6">
          ...
          <div className="flex flex-col items-center gap-4 sm:hidden w-full">
            <div className="flex items-center justify-between w-full bg-zinc-950 border border-zinc-800 p-1.5 rounded-2xl shadow-inner">
              ...
              <div className="flex flex-col items-center">
                ...
                <span className="text-sm font-black text-white">
                  {currentPage} <span className="text-zinc-600 mx-1">/</span>{" "}
                  {totalPages}
                </span>
              </div>
            ...
            <p className="text-[10px] text-zinc-500 font-bold uppercase tracking-tighter">
              ...
              dari{" "}
              <span className="text-zinc-300">{filteredListings.length}</span>{" "}
              produk
            </p>
          </div>
          ...
          <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
            <div>
              <p className="text-sm text-zinc-500 font-bold">
                ...
                dari{" "}
                <span className="text-white">{filteredListings.length}</span>{" "}
                hasil
              </p>
            </div>
            <div>
              <nav
                ...
                className="isolate inline-flex -space-x-px rounded-xl shadow-sm border border-zinc-800 overflow-hidden"
              >
                <button
                  onClick={() => goToPage(currentPage - 1)}
                  disabled={currentPage === 1}
                      ...
                      if (
                        ...
                        if (page === 2 || page === totalPages - 1) {
                          return (
                            <span
                              key={`ellipsis-${page}`}
                              className="relative inline-flex items-center px-4 py-2 text-sm font-semibold text-zinc-600 bg-zinc-900 border-x border-zinc-800"
                            >
                              ...
                            </span>
                          );
