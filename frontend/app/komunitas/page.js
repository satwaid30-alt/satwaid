...
export default function KomunitasPage() {
    ...
    const dynamicCategories = Object.keys(categoriesMap).map((key, index) => ({
        id: index + 1,
        name: key,
            ...
            if (res.ok) {
                ...
                setTopicsData(prev => prev.map(t => {
                    if (t.id === topicId) {
                        ...
                        const newTopicLikes = data.has_liked
                            ? [...(t.topic_likes || []), { user_id: currentUser.id }]
                            : (t.topic_likes || []).filter(like => like.user_id !== currentUser.id);
                                    ...
                                    >
                                        ...
                                        <div className="flex items-center gap-3 mb-3">
                                            ...
                                            <div className="flex items-center gap-2 flex-1 min-w-0 flex-wrap">
                                                ...
                                                <span className="text-xs text-zinc-400 font-medium ml-auto shrink-0">
                                        ...
                                        {/* Title & Description */}
                                        <h3 className="text-lg sm:text-xl font-black text-zinc-900 group-hover:text-emerald-600 transition-colors leading-tight mb-2">
                                            {topic.title}
                                        </h3>
                                        ...
                                        <div className="flex items-center justify-between mt-4 pt-4 border-t border-zinc-100">
                                            <span className="px-3 py-1.5 bg-zinc-50 text-zinc-500 text-[9px] font-black rounded-full uppercase tracking-[0.1em] border border-zinc-100 group-hover:bg-emerald-50 group-hover:text-emerald-600 group-hover:border-emerald-100 transition-all">
                                            ...
                                            <div className="flex items-center gap-3 sm:gap-4">
                                                ...
                                                <button
                                                    ...
                                                    className={`flex items-center gap-1.5 text-sm font-semibold transition-all hover:scale-110 active:scale-95 ${currentUser && topic.topic_likes?.some(like => like.user_id === currentUser.id)
                                                        ? 'text-rose-500'
                        ...
                        {totalPages > 1 && (
                            <div className="pt-4 flex justify-center items-center gap-1.5">
                                <button
                                    ...
                                    className="p-2.5 bg-white border border-zinc-200 hover:bg-zinc-50 disabled:opacity-40 disabled:cursor-not-allowed text-zinc-500 rounded-xl transition-all"
                                >
                                    <ChevronLeft size={17} />
                                </button>
