    ...
    try {
      ...
      if (response.ok) {
        ...
        setActionModal({
          ...
          message:
            "Pesanan Anda telah dibuat. Silakan lengkapi data pengiriman untuk melanjutkan.",
          onConfirm: () => {
        ...
        setActionModal({
          ...
          title: "Gagal Memesan",
          message:
            data.message || "Terjadi kesalahan saat memproses pesanan Anda.",
          onConfirm: null,
        });
      }
    } catch (err) {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setActionModal({
          ...
          message:
            err.message || "Terjadi kesalahan saat menyimpan ke keranjang.",
          onConfirm: null,
        });
      }
    } catch (err) {
  ...
  const handleShare = async () => {
    ...
    if (success) {
      setActionModal({
        ...
        message:
          "Tautan produk telah disalin ke clipboard Anda. Silakan bagikan ke teman Anda!",
        onConfirm: null,
      });
    } else {
      setActionModal({
      ...
      <div className="min-h-screen flex items-center justify-center bg-zinc-50 pt-20">
        <div className="text-center">
          ...
          <p className="text-zinc-500 mb-8">
            Maaf, produk yang Anda cari mungkin sudah tidak tersedia atau
            dihapus.
          </p>
          <Link
            href="/toko"
            className="bg-emerald-500 text-white font-black px-8 py-3 rounded-2xl hover:bg-emerald-600 transition-all"
          >
            Kembali ke Toko
          </Link>
        </div>
  ...
  return (
    <div className="min-h-screen bg-zinc-50 pt-20 lg:pt-28 pb-6 flex flex-col">
      <div className="max-w-[1440px] mx-auto px-4 w-full flex-1 flex flex-col">
        ...
        <Link
          href="/toko"
          className="inline-flex items-center gap-2 text-zinc-500 hover:text-emerald-600 font-bold mb-4 transition-colors group text-sm"
        >
              ...
              <div className="absolute bottom-6 inset-x-0 flex justify-center gap-2 px-4 overflow-x-auto no-scrollbar">
                {parsedImages.map((img, idx) => (
                  <button
                    ...
                    className={`w-14 h-14 rounded-xl border-2 overflow-hidden transition-all flex-shrink-0 bg-white ${activeImageIndex === idx ? "border-emerald-500 scale-105" : "border-white opacity-60 hover:opacity-100"}`}
                  >
                    <img
                      src={img}
            ...
            <div className="space-y-6 lg:space-y-8">
              <div>
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <span
                    className={`text-[9px] font-black uppercase tracking-widest px-2 py-1 rounded-md border ${selectedProduct.type === "sell" ? "bg-blue-100 text-blue-700 border-blue-200" : "bg-amber-100 text-amber-700 border-amber-200"}`}
                  >
                  ...
                  <div className="flex items-center gap-4 w-full sm:w-auto">
                    ...
                    <div className="min-w-0">
                      <div className="flex items-center gap-2 mb-0.5">
                        <p className="text-sm font-black text-blue-600 hover:underline cursor-pointer truncate">
                          {selectedProduct.shop?.name || "Seller"}
                        </p>
                      ...
                      <div className="flex flex-col sm:flex-row items-start gap-4 w-full sm:w-auto">
                        <div className="flex flex-col gap-1 w-full sm:w-auto">
                          ...
                          <p className="text-[10px] font-black text-zinc-500 uppercase tracking-tighter text-center">
                            Stok Tersedia: {selectedProduct.stock} Ekor
                          </p>
                        </div>
                        ...
                        <div className="flex items-center gap-2 h-12 w-full">
                          ...
                          <button
                            ...
                            disabled={isBuying}
                            className="flex-1 bg-emerald-500 hover:bg-emerald-600 text-white font-black px-6 rounded-xl text-xs transition-all active:scale-95 disabled:opacity-50 h-full flex items-center justify-center"
                          >
