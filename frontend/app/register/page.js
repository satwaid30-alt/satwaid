        ...
        <div className="min-h-screen bg-[#050505] flex items-center justify-center p-4 relative overflow-hidden font-sans selection:bg-emerald-500/30">
            ...
            {showModal && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
                    ...
                    <div className="bg-zinc-900 border border-emerald-500/30 w-full max-w-sm rounded-[2.5rem] relative z-10 overflow-hidden shadow-2xl animate-in zoom-in-95 duration-300 p-8 text-center">
                ...
                <div className="hidden md:flex flex-col justify-between p-12 relative overflow-hidden bg-emerald-500/5">
                    ...
                    <div className="relative z-10 space-y-6">
                        ...
                        <p className="text-zinc-400 text-lg leading-relaxed max-w-sm">
                            Bergabunglah dengan ribuan pecinta fauna. Temukan satwa impian dan bertransaksi dengan aman di platform terpercaya.
                        </p>
                    </div>
                ...
                <div className="p-8 md:p-12 flex flex-col justify-center bg-black/20">
                    <div className="mb-10">
                        <div className="md:hidden mb-8">
                            <Link href="/" className="flex items-center gap-2">
                                <span className="text-2xl font-bold text-white">Dunia<span className="text-emerald-500">Reptil</span></span>
                            </Link>
                        </div>
                    ...
                    <form onSubmit={handleRegister} className="space-y-6">
                        ...
                        <button
                            type="submit"
                            disabled={isLoading}
                            className="w-full py-4 bg-emerald-500 hover:bg-emerald-400 text-zinc-950 font-black rounded-2xl transition-all shadow-[0_0_20px_rgba(16,185,129,0.3)] hover:shadow-[0_0_30px_rgba(16,185,129,0.5)] active:scale-[0.98] flex items-center justify-center gap-2 mt-4"
                        >
                            {isLoading ? (
